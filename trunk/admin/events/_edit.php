<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'bDaylightSavings',$info['bDaylightSavings'],$audit,$table,$info['ID']);
	list($mysqlStr,$audit) = set_strs($mysqlStr,'bSignageLock',$info['bSignageLock'],$audit,$table,$info['ID']);
