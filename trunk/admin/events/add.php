			...
			<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tcleft" colspan="3">
						...
						<?=form_checkbox(array('type'=>'radio','caption'=>'Enable Daylight Savings Time?','title'=>'No','name'=>'bDaylightSavings','id'=>'bDaylightSavings0','value'=>'0','checked'=>'true'))?>&nbsp;&nbsp;&nbsp;
						<?=form_checkbox(array('type'=>'radio','title'=>'Yes','name'=>'bDaylightSavings','id'=>'bDaylightSavings1','value'=>'1'))?>
						...
						<?=form_checkbox(array('type'=>'radio','caption'=>'Lock Signage Submittion','title'=>'No','name'=>'bSignageLock','id'=>'bSignageLock0','value'=>'0','checked'=>'true'))?>&nbsp;&nbsp;&nbsp;
						<?=form_checkbox(array('type'=>'radio','title'=>'Yes','name'=>'bSignageLock','id'=>'bSignageLock1','value'=>'1'))?>
						
					</td>
					<td class="tcgutter"></td>
					<td class="tcright">
						<?=form_textarea(array('caption'=>'Text Message <span id="txtMsgCount">0</span>/150','name'=>'chrTextMessage','cols'=>'43','rows'=>'5','extra'=>'onkeyup=txtMsgCounter(this); onchange=txtMsgCounter(this);'))?>
						...
						<table cellpadding="3" cellspacing="0" width="100%" border="1" style="font-size:10px;">
							...
							<tr>
								<td>[EVENT]</td>
								<td>Displays Event Name (Length Varies)</td>
							</tr>
							<tr>
								<td>[STATION]</td>
