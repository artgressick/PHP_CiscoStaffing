<?
	...
	list($mysqlStr,$audit) = set_strs($mysqlStr,'bMarcom',$info['bMarcom'],$audit,$table,$info['ID']);
	list($mysqlStr,$audit) = set_strs($mysqlStr,'bLocked',$info['bLocked'],$audit,$table,$info['ID']);
	list($mysqlStr,$audit) = set_strs($mysqlStr,'BadgeNum',$info['BadgeNum'],$audit,$table,$info['ID']);
