...
?>
						<?=form_select($mobilecarriers,array('caption'=>'Mobile Carrier','required'=>'Required) (For SMS Alerts','name'=>'idMobileCarrier'))?>
<?					
...
?>
						...
						<?=form_text(array('caption'=>'Badge Number','name'=>'BadgeNum','size'=>'30','maxlength'=>'30'))?>
					...
					<td class="tcright">
						...
						<?=form_checkbox(array('type'=>'radio','caption'=>'Marcom Manager?','title'=>'No','name'=>'bMarcom','id'=>'bMarcom0','value'=>'0','checked'=>'true'))?>&nbsp;&nbsp;&nbsp;
						<?=form_checkbox(array('type'=>'radio','title'=>'Yes','name'=>'bMarcom','id'=>'bMarcom1','value'=>'1'))?>
<?					
