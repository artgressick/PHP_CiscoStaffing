<?
	...
	function sitm() { 
		global $BF,$info;
?>
		<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0" style='margin-top:0;padding-top:0;'>
			<tr>
				<td class="tcleft">
...
*/ ?>
		...
		<div style='padding-top:10px;'>
			<input type='button' value='Edit This User' onclick="edituser('<?=$info['chrKEY']?>');" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type='button' value='Close Window' onclick='window.close();' />
		</div>
