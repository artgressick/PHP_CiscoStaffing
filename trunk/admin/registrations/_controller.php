<?
	...
	switch($file_name[0]) {
		...
		case 'index.php':
			...
			$filters = form_select($filter,array('name'=>'idStatus','caption'=>'-Select Status-','nocaption'=>'true','value'=>$_REQUEST['idStatus'],'extra'=>'onchange="javascript:document.getElementById(\'idFilterForm\').submit();"'));
