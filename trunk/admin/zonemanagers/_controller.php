<?
	...
	switch($file_name[0]) {
		...
		case 'index.php':
			...
			$page_title = linkto(array('address'=>'add.php','img'=>'plus_add.png','style'=>'float:left;')).'&nbsp;&nbsp;Zone Managers <span class="resultsShown">(<span id="resultCount">'.mysqli_num_rows($results).'</span> results)</span>';
