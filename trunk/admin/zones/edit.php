...
<?
						$q = "SELECT ID, chrLocation AS chrRecord FROM Locations WHERE !bDeleted and idEvent = '".$_SESSION['idEvent']."' ORDER BY chrLocation";
			...
			<table width="100%" class="twoCol" id="twoCol" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tcleft" style='vertical-align:top;'>
						<?=form_text(array('caption'=>'Zone Name','required'=>'true','name'=>'chrZone','size'=>'30','maxlength'=>'100','value'=>$info['chrZone']))?>
