...
//	alert(height +'px');
	document.getElementById('gray').style.height = myHeight + "px";
	document.getElementById('gray').style.width = myWidth + "px";
...
function revertPopup() {
	...
	document.getElementById('idLocation').style.display = '';
}
		</script>
