...
?>
							...
							<table cellspacing="0" cellpadding="0" border="0" width="100%" style="padding:10px;padding-right:5px; margin-top:10px;">
								<tr>
									...
									<td background="<?=$BF?>images/wire-header-bg.gif" style='font-weight:bold; color:#282828;font-size:12px;padding:0px; margin:0px;padding-left:5px; width:100%;'>My schedule for <?=$_SESSION['chrEvent']?></td>
									<td style='width:4px;padding:0px; margin:0px; text-align:right;' align="right" background="<?=$BF?>images/wire-header-bg.gif"><img src="<?=$BF?>images/wire-header-right.gif"></td>
								</tr>
								<tr>
...
?>
							...
							<table cellspacing="0" cellpadding="0" border="0" width="100%" style="padding:10px;padding-right:5px;">
								<tr>
									<td style='width:4px;padding:0px; margin:0px;' align="left" background="<?=$BF?>images/wire-header-bg.gif"><img src="<?=$BF?>images/wire-header-left.gif"></td>
									<td background="<?=$BF?>images/wire-header-bg.gif" style=' width:100%;font-weight:bold; color:#282828;font-size:12px;padding:0px; margin:0px;padding-left:5px;'>My schedule for <?=$_SESSION['chrEvent']?></td>
									<td style='width:4px;padding:0px; margin:0px; text-align:right;' align="right" background="<?=$BF?>images/wire-header-bg.gif"><img src="<?=$BF?>images/wire-header-right.gif"></td>
								</tr>
								<tr>
				              		<td style="border:solid 1px #c0c1c2;" colspan='3'>
