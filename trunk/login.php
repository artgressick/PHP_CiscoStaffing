		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="40%" valign="top">
					...
					<div style="color:#666666; font-size:12px; padding-top:15px; padding-right:10px;">In order to register for Cisco Live Trade Show staffing, you must create a profile. Please click the button below to begin the process.</div>
