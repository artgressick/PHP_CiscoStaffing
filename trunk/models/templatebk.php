			...
			<table width='100%' cellpadding='0' cellspacing='0' border='0' style='padding:0;margin:0;'>
				<tr>
					<td style='vertical-align:top;'>
						<table cellspacing="0" cellpadding="0" border="0" style="padding:10px;padding-right:5px;">
							<tr>
		  	...
		  	<table width="908" border="0" cellspacing="0" cellpadding="0">
			  	<tr>
					...
					<td width="100%" height="45" bgcolor="#C2CED8">
						<div class="Copyright">
							<p class="Copyright">&copy; <?=date('Y')?>, Cisco, Inc. Internal Use Only</p>
							<p class="Copyright">Cisco Staffing Version 1.0a built by techIT Solutions</p>
						</div>
					</td>
