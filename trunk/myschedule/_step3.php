<?
		...
		if ($errcnt == 0) {
			...
			<p>Congratulations you've registered for staffing at ".$_SESSION['chrEvent'].". Stay tuned for the booth times you're been selected to staff.</p>
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<p>Keep in mind that you will only be assigned to work a maximum of two shifts per day.</p>

			<p>Once you have been selected to staff the event, details can be found at the URL above. You'll also be receiving an email prior to the start of the event with important staffing information.<p>
			
			<p>You may consider waiting to book travel until you know your staffing schedule has been confirmed.</p>
			
			<p>Send questions to <a href='mailto:".$PROJECT_EMAIL."'>".$PROJECT_EMAIL."</a>.</p>
			
			<p>Thanks. See you at ".$_SESSION['chrEvent']."!<br />
			".$PROJECT_NAME."</p>";
